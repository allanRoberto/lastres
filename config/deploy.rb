...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/lastres.git"
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/lastres"
...
set :local_domain, 'lastres.art.com.br'
